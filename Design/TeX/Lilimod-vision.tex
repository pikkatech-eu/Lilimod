...
\begin{document}
	...
	\Li can be conceived as a treatise on the linear models of \gw dynamics (and similar processes, e.g. heat transfer and diffusion).
	
	\section{Contents}
	\Li consists of two conceptual elements: a text, or a book, and a software package containing program code.
	
	The book describes the phenomena pertaining to \gw dynamics, its formalization in terms of linear models, and the mathematical apparatus used. 
	
	The software package contains code that, on the one hand, illustrates the equations dealt with in the book, on the other hand, it can be used to directly perform desired calculations.
	
	\section{Software package}
	The software package is going to be created as maximally OS-blind. At the time of writing, the environment of choice is Python (V.3.12+).
