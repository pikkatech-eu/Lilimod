...
class Plotter:
    def plot(self, data: list[(float, float)], **kwargs) -> None:
        """
        Plota s simple graph using simple data list.
        ...
        label   = kwargs.get("label_x", DEFAULT_LABEL)
        ...
        ax.plot(x, y, linewidth=2.0, label=label, antialiased=True)
...
if __name__ == '__main__':
    ...
    plotter.plot(data, title="test!", x_min=0, x_max=1, y_min=0, y_max=1)