...
\begin{ltablex}{\textwidth}{|X|X|X|}
	\caption{Sample multipage table}\label{tab:modelzoo} \\
	\hline
	...
	% Table rows
	ResNet50 & Residual network with 50 layers & 25M \\
	VGG16    & Very deep convolutional network & 138M \\
	Transformer & Sequence-to-sequence architecture & 65M \\
	\lipsum[1][1-5] & Dummy long text & 1M \\
	\lipsum[2][1-5] & Another long text & 2M \\
	% ... add more rows as needed
\end{ltablex}

%\begin{ltablex}{0.9\textwidth}{|l|l|X|X|}
%	\hline
