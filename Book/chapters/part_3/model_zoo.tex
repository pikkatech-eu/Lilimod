...
\chapter{Model Zoo}
	...
	In the literal codes of the aquifers the first letter is the literal code pertaining to the geometry, followed by a combination of \textit{r} and \textit{i} letters, where \textit{r} corresponds to a recharge boundary, \textit{i} to an impermeable boundary.
